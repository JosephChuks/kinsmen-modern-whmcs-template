        ...
        {foreach $productGroups as $productGroup}
            ...
            <div class="card mb-3">
                <div class="card-body p-lg-4 p-xl-5 text-center">
                    ...
                    <p style="color:var(--text-secondary)">{$productGroup->tagline}</p>
        ...
        {if $registerdomainenabled}
            <div class="card mb-3">
                <div class="card-body p-lg-4 p-xl-5 text-center">
                    ...
                    <p style="color:var(--text-secondary)">{lang key='secureYourDomain'}</p>
                    <a href="{$WEB_ROOT}/cart.php?a=add&domain=register" class="btn btn-block btn-primary">
        ...
        {if $transferdomainenabled}
            <div class="card mb-3">
                <div class="card-body p-lg-4 p-xl-5 text-center">
                    ...
                    <p style="color:var(--text-secondary)">{lang key='transferExtend'}</p>
                    <a href="{$WEB_ROOT}/cart.php?a=add&domain=transfer" class="btn btn-block btn-primary">
                        {lang key='transferYourDomain'}
                    </a>
                </div>
            </div>
