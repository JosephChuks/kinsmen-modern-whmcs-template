                            ...
                            {else}
                                ...
                                {if $username}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7 text-left">
                                        <input type="password" id="password" value="{$password}" style="border:none;outline:none;width:45%" />
                                            
                                            <button style="outline:none;border:none" class="btn btn-info btn-sm ml-2" onclick="togglePassword('password', 'toggleIcon')"><i id="toggleIcon" class="fas fa-eye"></i> view</button>
                                            
                                            <button id="copybtn" style="outline:none;border:none" class="btn btn-danger btn-sm ml-1" onclick="copyToClipboard('copybtn', 'password')"><i class="fas fa-clipboard"></i> copy</button>
                                        </div>
